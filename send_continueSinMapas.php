		...
		<div class="pgHdr">
			...
			<div id="divImagen1" style="display:none">
				<div id="figure_1" class="question" style="margin:0 0 0 0;width:auto">
					<div class="qContent">
						<div class="qHeader">Give a phrase that identify the object pointed to by the arrow</div>
						<div class="qBody">
							<img src=".jpg" alt="F1" />
						</div>
					</div>
			...
			<div id="divImagen2" style="display:none">
				<div id="figure_2" class="question" style="margin:0 0 0 0;width:auto">
					<div class="qContent">
						<div class="qHeader">Give a phrase that identify the object pointed to by the arrow
						</div>
						<div class="qBody">
							<img src=".jpg" alt="F2" />
						</div>
