...
<form name="frmIdioma" method="post" action="select_language.php" id="frmS">
				...
				<div class="qContent">
					...
					<div class="qContent">
						<div class="qHeader">
							...
							<abbr class="noborder" title="Pregunta 0"></abbr> Seleccione el idioma
						</div>
						...
						<div class="qBody">
							...
							<div class="hlbl">
								<label for="input_idioma">Seleccione el idioma</label>
							</div>
						</div>
					</div>
			</div>
	<div id="panButtonBar">
		<div style="text-align:center;">
			<input type="submit" name="NextButton" value="Siguiente" onclick="return validar();onesubmit(this);" id="NextButton" class="btn btntext grey" />
		</div>
	</div>
...
<script type="text/javascript">
	...
	function validar(){
		if (document.getElementById('input_idioma').value == ''){ 
			alert("Debe seleccionar el idioma\n");
		 	return false;
		} else {
			return true;
		}
