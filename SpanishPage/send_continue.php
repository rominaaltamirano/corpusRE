...
<head><title>Expresiones Referenciales</title>
...
<script type="text/javascript">
	...
	function first() {
		...
		document.getElementById("divImagen" + numero_mostrar).focus();
	}
	...
	function next(ret, element, id_persona) {
		...
		if(document.getElementById("text_f" + numero_mostrar).value!='' && ret)
		{
			...
			save_data("id_persona=" + id_persona + "&id_mapa=" + numero_mostrar + "&expresion_referencial=" + document.getElementById("text_f" + numero_mostrar).value);
	...
	<div id="PageContentDiv">
		<h1 class="sTitle sTitleCf">
			<div style="text-align:left;">
				<span class="notranslate">Expresiones Referenciales</span>
			</div>
		</h1>
		<div class="pTitle">
			<h2></h2>&nbsp;
		...
		<div class="pgHdr">
			...
			<div id="divImagen1" style="display:none">
				<div id="figure_1" class="question" style="margin:0 0 0 0;width:auto">
					<div class="qContent">
						<div class="qHeader">Dar una frase que identifique al objeto apuntado</div>
						<div class="qBody">
							<img src=".jpg" alt="F1" />
						</div>
					</div>
			...
			<div id="divImagen2" style="display:none">
				<div id="figure_2" class="question" style="margin:0 0 0 0;width:auto">
					<div class="qContent">
						<div class="qHeader">Dar una frase que identifique al objeto apuntado
						</div>
						<div class="qBody">
							<img src=".jpg" alt="F2" />
						</div>
...
<!-- de la 10 a la 20-->
			<div id="gracias" class="question" style="display:none">
				<div class="qContent">
					<div class="qHeader">Agradecemos su participación!
					</div>
					<div class="qBody">
						<img src=".jpg" alt="gracias" />
					</div>
				</div>
			</div>
			</div>
	...
	<!--end content area-->
		<div id="panButtonBar">
			<div style="text-align:center;">
				<input type="submit" name="NextButton" value="Siguiente" onclick="var ret = validar_datos(); return next(ret, this, '<?php echo $id_persona;?>');" id="NextButton" class="btn btntext grey" />
			</div>
		</div>
	</div>
</form>
...
<script type="text/javascript">
	...
	function validar_datos()
	{
		...
		if ((document.getElementById('divImagen1')).getAttribute("style").contains("inline") && (document.getElementById('text_f'+1).value).contains("amarelo")) 
		{
			
			mensaje_incorrectos+="\t-Su respuesta no deberia contener amarelo\n";
		}
		...
		{
			if(confirm("La expresión dada parece no ser correcta, confirma que desea enviar esa expresión?\n"+mensaje_incorrectos))
				return true;
			else
				return false;
		}
